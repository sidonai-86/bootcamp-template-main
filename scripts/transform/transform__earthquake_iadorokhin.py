...
create_main = f"""
    CREATE TABLE IF NOT EXISTS iadorokhin.{table_name} ON CLUSTER {cluster_name} (
        id String,
        ts DateTime,
        place String,
        region String,
...
create_distributed = f"""
    CREATE TABLE IF NOT EXISTS iadorokhin.{distributed_table_name}
    ENGINE = Distributed('{cluster_name}', 'iadorokhin', '{table_name}', rand())
    """
